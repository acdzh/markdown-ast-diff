...
这段文字包含**粗体**、*斜体*{----和----}{++++、++++}***粗斜体***&#x683C;式{----，还有----}{++++和++++}{----`行内代码`----}{----和----}{++++**新增的粗体**++++}{++++，还有++++}{++++`更新的行内代码`++++}{++++。++++}{----~~删除线~~----}{----文本。----}
...
{----[示例链接](https://example.com)----}{++++[更新后的示例链接](https://example.org)++++}
...
{----![示例图片](https://example.com/image.jpg)----}{++++![更新后的示例图片](https://example.org/updated-image.jpg)++++}
...
这个{++++更新后的++++}文档展示了多种 Markdown 元素的使用方式{++++及其变更++++}，可以用于测试差异比较功能{++++的效果++++}。
